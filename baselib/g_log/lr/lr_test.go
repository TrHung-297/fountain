 ...
 * -----
 * Last Modified: Monday, 12th July 2021 7:25:41 pm
...
// Verify that functions within the Lr package aren't considered when
...
func TestReportCallerHelperDirect(t *testing.T) {
	...
	assert.Equal(t, "info", fields["level"])
	assert.Regexp(t, "github.com/.*/lr.logSomething", fields["func"])
}
...
func TestParseLevel(t *testing.T) {
	...
	assert.Equal(t, "not a valid lr Level: \"invalid\"", err.Error())
}
...
// Compile test
func TestLrInterfaces(t *testing.T) {
	var buffer bytes.Buffer
