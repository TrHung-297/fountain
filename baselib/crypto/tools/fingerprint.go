 ...
 * -----
 * Last Modified: Thursday, 27th May 2021 10:30:43 am
...
func main() {
	...
	if block == nil {
		err := fmt.Errorf("invalid pem key data: %s", string(pkcs1PemPrivateKey))
		panic(err)
	}
